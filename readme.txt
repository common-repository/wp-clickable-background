...
[You can also download the plugin from here](https://github.com/webmarcello8080/wp-clickable-background "wp-clickable-background") 
...
1. Use the Settings -> WP Clickable Background screen to configure the plugin
1. Insert the required information and click on "Save Changes"
